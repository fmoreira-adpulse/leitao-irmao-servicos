...
class EnergyPlus {
  ...
  */
  ...
  public function start() {
    ...
    add_action('user_register',                         'EnergyPlus_Events::woocommerce_created_customer');
    ////
  ...
  public static function init() {
    ...
    if ( "1" === EnergyPlus::option('feature-pulse', "0")) {
    	if (EnergyPlus_Live::check_gpdr_cookie()) {
    		...
    		EnergyPlus::enable_live_pulse();
    	} else {
    		EnergyPlus_Live::delete_user_tracker_data();
    	}
    }
  }

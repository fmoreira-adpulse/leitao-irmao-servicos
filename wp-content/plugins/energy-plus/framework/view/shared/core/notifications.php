                      ...
                      <div class="row">
                        ...
                        <div class="col-11 __A__Content text-center">
                          <h2 class="__A__Widget_onlineusers_Notice">
                            <img src="<?php echo get_the_post_thumbnail_url(intval($message['details']['product_id'])); ?>" class="__A__Product_Image __A__Product_Image_Not __A__Notifications_Type_14x">
                            →
                      ...
                      <div class="row">
                        ...
                        <div class="col-11 __A__Content text-center pt-2">
                          <?php if ('empty' !== $message['details']['icon']) { ?>
                            <i class="<?php echo esc_attr($message['details']['icon']) ?> __A__Notifications_Type_15x"></i>
                            <br>  <br>
                          <?php } ?>

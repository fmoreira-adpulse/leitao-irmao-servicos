          ...
          <div class="__A__Item_Details">
            <div class="row">
              <div class="col-sm-12 __A__Customer_Details_Actions">
                ...
                <a href="<?php echo admin_url( "user-edit.php?user_id=" . esc_attr($customer['id'])); ?>" class="__A__HideMe __A__StopPropagation trig no-refresh"><?php esc_html_e('Edit customer', 'energyplus'); ?></a>

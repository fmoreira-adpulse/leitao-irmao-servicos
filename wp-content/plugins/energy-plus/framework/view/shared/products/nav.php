        ...
        <li class="__A__Li_Search">
          ...
          <div class="btn-group">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item" href="<?php echo EnergyPlus_Helpers::thead_sort('menu_order')?>"><?php esc_html_e('Position', 'energyplus'); ?></a>
...
<div class="energyplus-title--menu __A__Coupons_Mode_2 __A__Scroll __A__OrderBy">
  <div class="row energyplus-gp __A__GP">
    <ul>
      <li><?php esc_html_e('Order by', 'energyplus'); ?></li>
      <li>&nbsp;&nbsp;&nbsp;&nbsp;  &mdash;</li>
      ...
      <li><a class="__A__Button1<?php EnergyPlus_Helpers::selected('orderby', 'menu_order')?>" href="<?php echo EnergyPlus_Helpers::thead_sort('menu_order')?>"><?php esc_html_e('Position', 'energyplus'); ?></a></li>

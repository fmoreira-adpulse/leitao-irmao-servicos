...
<?php echo EnergyPlus_View::run('header-page', array('type'=> 1, 'title' => esc_html__('Attributes', 'energyplus'), 'description' => '', 'buttons'=>'<a href="' . admin_url( 'edit.php?post_type=product&page=product_attributes' ). '" class="btn btn-sm btn-danger trig trig-refresh"> + &nbsp; ' . esc_html__('New attribute', 'energyplus'). ' &nbsp;</a>')); ?>
        ...
        <div class="row align-middle align-items-center __A__Item" id='item_<?php echo esc_attr($attribute['id'])  ?>'>
          ...
          <div class="col __A__Col_Actions __A__Col_5x  __A__Col_3 align-middle __A__Actions2">
            <ul class="float-right">
              <li><a href="<?php echo admin_url( 'edit-tags.php?taxonomy=' . $attribute['slug']. '&post_type=product' );?>" class="__A__Button1 __A__MainButton trig"><?php esc_html_e('Terms', 'energyplus'); ?></a></li>

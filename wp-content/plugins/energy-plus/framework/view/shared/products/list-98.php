          ...
          <div class="liste  row d-flex align-items-center">
            ...
            <div class="__A__Col_3 col-2 align-middle text-center"  data-colname="Stock">
              ...
              <div class="__A__Stocks text-left __A__Display_None">
                ...
                <input type="checkbox" name="outofstock" data-id="<?php echo  esc_attr($product['id'])?>"  class="__A__StockAjax" <?php if ('1' <> $product['in_stock']) echo ' checked'; ?>> <?php esc_html_e('Out of Stock', 'energyplus'); ?><br>
              </div>
            </div>

                  ...
                  <div class="btnA __A__Item collapsed"   data-id="<?php echo esc_attr($product['id']) ?>" id="item_<?php echo  esc_attr($product['id']) ?>" data-toggle="collapse" data-target="#item_d_<?php echo esc_attr($product['id']) ?>" aria-expanded="false" aria-controls="item_d_<?php echo  esc_attr($product['id']) ?>">
                    <div class="liste  row d-flex align-items-center">
                      ...
                      <?php if ('variant' !== $product['type']) {   ?>
                        ...
                        <div class="__A__Col_Title col-6 col-sm-3 align-middle eix-quick" href="<?php echo admin_url( 'post.php?post=' . $product['id']. '&action=edit&energyplus_hide' );?>">
                        ...
                        <div class="row">
                          ...
                          <?php if ('trash' === $product['status']) {  ?>
                            <div class="col-12 col-sm-12 __A__Product_Actions text-right">
                              <?php do_action('energyplus_before_product_actions', intval($product['id'])) ?>
                              ...
                              <?php do_action('energyplus_after_product_actions', intval($product['id'])) ?>
                            <?php } else {  ?>
                              <div class="col-12 col-sm-3 __A__Product_Actions">
                                ...
                                <br /><br />
                                <a href="<?php echo admin_url( 'admin.php?page=wc-admin&path=%2Fanalytics%2Fproducts&filter=single_product&products=' . $product['id']. '&period=year&compare=previous_year&interval=month' );?>" class="__A__StopPropagation trig" data-hash="<?php echo esc_attr($product['id'])?>" data-width="1281px"><?php esc_html_e('Statistics', 'energyplus'); ?></a>
                                <br /><br />

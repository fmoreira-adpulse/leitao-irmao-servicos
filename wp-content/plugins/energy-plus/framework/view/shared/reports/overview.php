  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="__A__Reports_Top_Cards row w-100">
        <?php if (0 === (int)EnergyPlus_Helpers::get("month")) { ?>
...
<div class="__A__Reports_Div">
  <div class="__A__Reports_Div_Inner table-responsive ">
    ...
    <table class="__A__Reports_Table table table-hover text-center">
      <thead>
        ...
        <?php foreach (apply_filters('energyplus_extends_reports_columns', array()) AS $k=>$v) { ?>
          <th class="text-right"><?php echo esc_html($v) ?> (<?php echo get_woocommerce_currency_symbol()?>)</th>
        <?php } ?>
      ...
      <tbody>
        ...
        foreach ($data['results_r'] AS $date) {
          ...
          <tr>
            ...
            <?php if (0 < $visitor_total) { ?>
              <td><span class="__A__Report_Inline_Edit<?php if (1 === $in) {echo "_Disabled";}?>" data-t="<?php echo esc_attr(EnergyPlus_Helpers::get('range','daily'))?>" data-day="<?php echo esc_attr($date['day'])?>"><?php echo (isset($date['visitors'])) ? intval($date['visitors']) : '0' ?></span></td>
              <?php } ?>
              ...
              <td class="text-right" ><?php echo floatval(0 !== intval($date['total_sales']))? wc_price($date['total_sales']) : '-' ?>
                ...
                } elseif ($date['total_sales'] > $date['prev']) {
              ...
              <td class="text-right" ><span class="__A__Goal_Bullet<?php if ($date['total_sales']<=$date['goal']) { echo ' text-danger'; } else { echo ' text-success'; } ?>"><?php echo wc_price($date['total_sales']-$date['goal'])?> &nbsp; &#11044;</span></td>
  ...
  <?php if ('yearly' !== EnergyPlus_Helpers::get("range") && 0 === (int)EnergyPlus_Helpers::get("month")) { ?>
    <div class="__A__Reports_Div">
  ...
  <?php if (1==1 && '' === EnergyPlus_Helpers::get("range")) { ?>
    <div class="__A__Reports_Div pb-4">
      <div class="__A__Reports_Div_Inner text-center">
        <a href="<?php echo EnergyPlus_Helpers::admin_page('reports', array( 'month' => (int)EnergyPlus_Helpers::get("month")+1 ));  ?>" class="__A__Dashboard_Buttons">	← <?php echo date_i18n('F',  strtotime("-" . ((int)EnergyPlus_Helpers::get("month")+1) . ' MONTH')) ?></a>

        &nbsp; &nbsp;

        <?php if (0 < (int)EnergyPlus_Helpers::get("month")) { ?>
          <?php echo date_i18n('F',  strtotime("-" . ((int)EnergyPlus_Helpers::get("month")) . ' MONTH')) ?>
          &nbsp; &nbsp;
          <a href="<?php echo EnergyPlus_Helpers::admin_page('reports', array( 'month' => (int)EnergyPlus_Helpers::get("month")-1 ));  ?>" class="__A__Dashboard_Buttons"><?php echo date_i18n('F',  strtotime("-" . ((int)EnergyPlus_Helpers::get("month")-1) . ' MONTH')) ?> 	→</a>
        <?php } ?>
      </div>

...
<div class="__A__Widget_Links_S h-100">
  ...
  <?php if (0 === count($items)) { ?>
    <div class="__A__EmptyTable <?php if (0 < count($items)) echo ' d-none'; else echo 'd-flex'; ?> align-items-center justify-content-center text-center">
      <div><a class="trig __A__Widget_Links_Create" href="<?php echo EnergyPlus_Helpers::admin_page('dashboard', array('action'=>'wd_settings', 'id'=>$args['id']))?>"><?php esc_html_e('Create a shortcut', 'energyplus'); ?></a></div>
    </div>
  <?php } ?>

      ...
      <table class="table table-hover">
        <thead>
          <tr class="__A__Standart">
            ...
            <th scope="col" class="__A__Table_Col3"><?php esc_html_e('Status', 'energyplus') ?></th>
            <th scope="col"  class="__A__Table_Col4 __A__Col_Customer"><?php esc_html_e('Customer', 'energyplus') ?></th>
            <th scope="col"  class="__A__Table_Col5"><a href="<?php echo EnergyPlus_Helpers::thead_sort('post_date')?>"><?php esc_html_e('Details', 'energyplus') ?></a></th>
            <th scope="col" class="__A__Table_Col6 __A__Col_Products"><?php esc_html_e('Products', 'energyplus') ?></th>
            <th scope="col"  class="__A__Table_Col7 text-right"><a href="<?php echo EnergyPlus_Helpers::thead_sort('meta__order_total')?>"><?php esc_html_e('Total', 'energyplus') ?></a></th>

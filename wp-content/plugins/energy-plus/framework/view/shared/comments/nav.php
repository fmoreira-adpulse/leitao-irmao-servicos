...
<div class="energyplus-title--menu __A__Coupons_Mode_2">
  <div class="row energyplus-gp">
    ...
    <ul>
      ...
      <li><a class="__A__Button1<?php EnergyPlus_Helpers::selected('status', 'trash')?>" href="<?php echo EnergyPlus_Helpers::admin_page('comments', array( 'status' => 'trash' ));  ?>"><?php echo esc_html_e('Deleted', 'energyplus'); ?> <?php echo esc_html(absint( $count->trash)) ?></a></li>

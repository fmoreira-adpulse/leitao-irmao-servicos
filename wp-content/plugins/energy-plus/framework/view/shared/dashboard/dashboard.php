...
<?php do_action('energyplus_before_dashboard') ?>
...
<div class="grid __A__GP">
  ...
  <?php do_action('energyplus_after_dashboard') ?>

  <div class="__A__Widget_Add __A__GP text-right"><a href="<?php echo EnergyPlus_Helpers::admin_page('dashboard', array('action'=>'widget_list'))?>" class="trig"><?php esc_html_e('Add or remove widgets', 'energyplus'); ?></a></div>

  <?php do_action('energyplus_after_dashboard_2') ?>

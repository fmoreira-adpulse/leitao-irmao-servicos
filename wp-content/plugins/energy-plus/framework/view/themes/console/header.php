          ...
          <li>
            ...
            <ul class="energyplus-header-submenu">
              <?php if ("1" === EnergyPlus::option('feature-own_themes') || EnergyPlus_Admin::is_admin(null) || (!EnergyPlus_Admin::is_admin(null) && '1' === EnergyPlus::option('reactors-tweaks-settings-woocommerce',0))) { ?>
                <li><a href="<?php echo EnergyPlus_Helpers::admin_page('settings');  ?>"><span class="energyplus-menu--textx"><?php esc_html_e('Settings', 'energyplus')?></span></a></li>
              <?php } ?>
              <li><a href="<?php echo esc_url_raw(get_bloginfo('url'))?>" target="_blank"><?php esc_html_e('View Store', 'energyplus'); ?></a></li>
              <li><a href="<?php echo get_edit_profile_url(); ?>"><span class="energyplus-menu--textx"><?php esc_html_e('Profile', 'energyplus'); ?></span></a></li>
              <li><a href="<?php echo wp_logout_url(); ?>"><span class="energyplus-menu--textx"><?php esc_html_e('Logout', 'energyplus')?></span></a></li>
            </ul>
          </li>
        </ul>
      </nav>

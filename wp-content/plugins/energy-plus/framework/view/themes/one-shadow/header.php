    ...
    <div>
      <div class="__A__GP row">
        ...
        <div class="col-4 text-right __A__Top_Right">
          <?php do_action('energyplus_top_left') ?>
        ...
        <?php do_action('energyplus_top_right') ?>
      </div>
    </div>
  </div>
</div>

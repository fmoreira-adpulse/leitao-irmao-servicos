      ...
      <div class="row">
        ...
        <div class="col-lg-9 __A__Description">
          <div class="col-lg-3 input-group __A__Settings_NCT">
            <input name="reactors-tweaks-window-size" class="__A__Settings_Input form-control"  placeholder="<?php echo esc_attr('1090'); ?>" value='<?php echo esc_attr(intval(EnergyPlus::option('reactors-tweaks-window-size', '1090px'))) ?>'/>
          ...
          <div class="__A__Item">
            <div class="row">
              <div class="col-lg-3 __A__Title">
                <?php esc_html_e('Order list', 'energyplus'); ?>
              </div>
              <div class="col-lg-9 __A__Description">


                <div class="form-check pl-0">
                  <input type="checkbox" value="60" name="reactors-tweaks-order-refresh" <?php if (0 < intval(EnergyPlus::option('reactors-tweaks-order-refresh', 0))) { echo " checked"; } ?>>
                    <?php esc_html_e('Refresh order list every 60 seconds', 'energyplus'); ?>
                  </div>

                  <?php if (57 === intval(EnergyPlus::option('feature-refresh', '30'))) { ?>
                    <br>
                    <div class="form-check pb-3 pl-0">
                      Beep if there is an order:
                      </div>
                      <?php
                      ...
                      $wc_statuses_all = wc_get_order_statuses();
                      $wc_statuses['trash'] = 'trash';
                      $wc_statuses_all['trash'] = __('Delete');

                      $status_refresh = EnergyPlus::option('reactors-tweaks-order-notify', array());

                      foreach ( wc_get_order_statuses() AS $key=>$value) {

                        echo " <div class='form-check pl-0'><input type='checkbox' value='1' name='order_notify[".esc_attr($key)."]' ";

                        if (isset($status_refresh[$key])) {
                          echo ' checked';
                        }
                      ...
                      <div class="col-sm-12 __A__Settings_NCT">
                        <div class="form-check">
                          ...
                          <select name="reactors-tweaks-landing" class="__A__Settings_Select form-control">
                            <option value="dashboard" <?php if (EnergyPlus::option('reactors-tweaks-landing', 'dashboard') === 'dashboard') {echo " selected";}?>><?php esc_html_e('Dashboard', 'energyplus'); ?></option>
                              <option value="orders" <?php if (EnergyPlus::option('reactors-tweaks-landing', 'dashboard') === 'orders') {echo " selected";}?>><?php esc_html_e('Orders', 'energyplus'); ?></option>
                                <option value="products" <?php if (EnergyPlus::option('reactors-tweaks-landing', 'dashboard') === 'products') {echo " selected";}?>><?php esc_html_e('Products', 'energyplus'); ?></option>
                                  <option value="reports" <?php if (EnergyPlus::option('reactors-tweaks-landing', 'dashboard') === 'reports') {echo " selected";}?>><?php esc_html_e('Reports', 'energyplus'); ?></option>
                                    <option value="customers" <?php if (EnergyPlus::option('reactors-tweaks-landing', 'dashboard') === 'customers') {echo " selected";}?>><?php esc_html_e('Customers', 'energyplus'); ?></option>
                                      <option  value="coupons" <?php if (EnergyPlus::option('reactors-tweaks-landing', 'dashboard') === 'coupons') {echo " selected";}?>><?php esc_html_e('Coupons', 'energyplus'); ?></option>
                                      </select>
                                      <br>
                          ...
                          <div class="__A__Item">
                            <div class="row">
                              ...
                              <div class="col-lg-7 __A__Description">
                                <div class="row">
                                  <div class="col-sm-2">
                                    <input type="number" step="1"  min="1" name="reactors-tweaks-pg-orders" class="form-control"  placeholder="<?php echo esc_attr('10'); ?>" value='<?php echo esc_attr(intval(EnergyPlus::option('reactors-tweaks-pg-orders', '10'))) ?>'/><br> <?php esc_html_e('Orders', 'woocommerce'); ?>
                                  </div>

                                  <div class="col-sm-2">
                                    <input type="number" step="1"  min="1" name="reactors-tweaks-pg-products" class="form-control"  placeholder="<?php echo esc_attr('10'); ?>" value='<?php echo esc_attr(intval(EnergyPlus::option('reactors-tweaks-pg-products', '10'))) ?>'/><br> <?php esc_html_e('Products', 'woocommerce'); ?>
                                  </div>

                                  <div class="col-sm-2">
                                    <input type="number" step="1"  min="1" name="reactors-tweaks-pg-coupons" class="form-control"  placeholder="<?php echo esc_attr('10'); ?>" value='<?php echo esc_attr(intval(EnergyPlus::option('reactors-tweaks-pg-coupons', '10'))) ?>'/><br> <?php esc_html_e('Coupons', 'woocommerce'); ?>
                                  </div>

                                  <div class="col-sm-2">
                                    <input type="number" step="1"  min="1" name="reactors-tweaks-pg-customers" class="form-control"  placeholder="<?php echo esc_attr('10'); ?>" value='<?php echo esc_attr(intval(EnergyPlus::option('reactors-tweaks-pg-customers', '10'))) ?>'/><br> <?php esc_html_e('Customers', 'woocommerce'); ?>
                                  </div>

                                  <div class="col-sm-2">
                                    <input type="number" step="1" min="1" name="reactors-tweaks-pg-comments" class="form-control"  placeholder="<?php echo esc_attr('10'); ?>" value='<?php echo esc_attr(intval(EnergyPlus::option('reactors-tweaks-pg-comments', '10'))) ?>'/><br> <?php esc_html_e('Comments'); ?>
                                  </div>
                              ...
                              <div class="col-lg-9 __A__Description">
                                <div class="row">
                                  ...
                                  <div class="__A__Item">
                                    <div class="row">
                                      <div class="col-lg-3 __A__Title">
                                        <?php esc_html_e('Quick Links', 'energyplus'); ?>
                                      </div>
                                      <div class="col-lg-9 __A__Description">
                                        <div class="row">
                                          <div class="col-sm-12 __A__Settings_NCT">
                                            ...
                                            <div class="form-check">
                                              <input type="checkbox" value="1" name="reactors-tweaks-settings-quicklinks" <?php if ("1" === EnergyPlus::option('reactors-tweaks-settings-quicklinks', "0")) { echo " checked"; } ?>>
                                                <?php esc_html_e('Enable Quick Links', 'energyplus'); ?>
                                              </div>
                                                  </div>
                                                </div>
                                              </div>
                                  ...
                                  <div class="__A__Item">
                                    <div class="row">
                                      <div class="col-lg-3 __A__Title">
                                        <?php esc_html_e('Custom CSS', 'energyplus'); ?>
                                      </div>
                                      <div class="col-lg-9 __A__Description">
                                        <div class="col-lg-12 input-group __A__Settings_NCT">
                                          <textarea rows="7" name="reactors-tweaks-custom-css" class="form-control w-100 h-25"><?php echo EnergyPlus::option('reactors-tweaks-custom-css', '')?></textarea>
                                              </div>
                                              <br>
                                              <?php esc_html_e('Please do not add <style></style> tags. The CSS codes you write here only affect the E+ panel.', 'energyplus'); ?>
                                            </div>
                                          </div>
                                        </div>

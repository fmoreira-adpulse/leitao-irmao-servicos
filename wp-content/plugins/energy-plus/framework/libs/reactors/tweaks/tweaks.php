...
class Reactors__tweaks__tweaks  {
  ...
  public static function settings() {
    ...
    if ($_POST) {
      ...
      // reactors-tweaks-order-refresh

      EnergyPlus::option('reactors-tweaks-order-notify', EnergyPlus_Helpers::sanitize_array($_POST['order_notify']), 'set');
      EnergyPlus::option('reactors-tweaks-order-refresh', EnergyPlus_Helpers::post('reactors-tweaks-order-refresh', 0), 'set');
      ...
      // reactors-tweaks-settings-quicklinks

      EnergyPlus::option('reactors-tweaks-settings-quicklinks', EnergyPlus_Helpers::post('reactors-tweaks-settings-quicklinks', 0), 'set');
      ...
      // reactors-tweaks-custom-css

      EnergyPlus::option('reactors-tweaks-custom-css', wp_strip_all_tags($_POST['reactors-tweaks-custom-css']), 'set');

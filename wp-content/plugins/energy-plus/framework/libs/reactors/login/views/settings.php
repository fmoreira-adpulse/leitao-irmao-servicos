                  ...
                  <div class="custom-img-container">
                    ...
                    <?php if ( $valid_img ) { ?>
                      <div class="__A__Settings_Logo __A__Settings_Logo_logo">
                        <a href="javascript:;" data-pr="logo" class="upload-custom-img"><img src="<?php echo esc_url($energyplus_img_src[0]) ?>"  <?php EnergyPlus_Helpers::style("max-height:120px")?> /></a>
                      </div>
                  ...
                  <div class="custom-img-container">
                    ...
                    <?php if ( $valid_img ) { ?>
                      <div class="__A__Settings_Logo __A__Settings_Logo_background">
                        <a href="javascript:;" data-pr="background" class="upload-custom-img"><img src="<?php echo esc_url($energyplus_img_src[0]) ?>"  <?php EnergyPlus_Helpers::style("max-height:120px")?> /></a>
                      </div>

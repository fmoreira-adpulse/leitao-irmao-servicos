...
echo sprintf( esc_html__( 'Some items have been ordered for your %1$s %2$s by %3$s.', 'nm-gift-registry' ),
...
/* translators: %s: date */
echo sprintf( esc_html__( 'Here are the details of the order placed on %s.', 'nm-gift-registry' ), wc_format_datetime( $order->get_date_created() ) ) . "\n\n";
...
echo esc_html( 'We look forward to fulfilling your order soon.', 'nm-gift-registry' ) . "\n";

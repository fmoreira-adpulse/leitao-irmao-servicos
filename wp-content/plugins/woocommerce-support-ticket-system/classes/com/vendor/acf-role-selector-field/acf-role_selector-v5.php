...
class acf_field_role_selector extends acf_field {
	...
	function render_field( $field ) {
		...
		?>
		<label style="margin-left:3px;"><input <?php echo $checked ?> type="<?php echo $field['field_type'] ?>" name="<?php echo $field['name'] ?>[]" value="<?php echo $role ?>"><?php echo $data['name'] ?></label>
		<?php
			endforeach;

...
class Provider extends \Jet_Smart_Filters_Provider_Base {
	...
	public function ajax_get_content() {
		$post_id          = ( isset( $_REQUEST['settings']['filtered_post_id'] ) && $_REQUEST['settings']['filtered_post_id'] !== '' )
			? absint( $_REQUEST['settings']['filtered_post_id'] )
			: false;
		$query_element_id = ( isset( $_REQUEST['settings']['element_id'] ) && $_REQUEST['settings']['element_id'] !== '' )
			? esc_attr( $_REQUEST['settings']['element_id'] )
			: false;

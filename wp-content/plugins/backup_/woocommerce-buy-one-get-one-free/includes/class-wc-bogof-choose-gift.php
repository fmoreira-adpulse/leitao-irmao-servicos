...
class WC_BOGOF_Choose_Gift {
	...
	public static function add_cart_item_data( $cart_item_data, $product_id, $variation_id ) {
		if ( ! wc_bogof_is_choose_your_gift_request() || WC_BOGOF_Cart::is_free_item( $cart_item_data ) ) {
	...
	public static function load_scripts() {
		...
		if ( self::is_cart() ) {
			wp_enqueue_script( 'wc-bogof-remove-duplicate-notices', plugins_url( 'assets/js/frontend/remove-duplicate-notices' . $suffix . '.js', WC_BOGOF_PLUGIN_FILE ), [ 'jquery' ], WC_Buy_One_Get_One_Free::$version, true );
		}
